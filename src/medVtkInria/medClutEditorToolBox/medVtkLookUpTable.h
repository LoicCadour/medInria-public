...
=========================================================================*/
// .NAME medVtkLookUpTable - map scalar values into colors via a lookup table
// .SECTION Description
// medVtkLookUpTable is an object that is used by mapper objects to map scalar
...
// When true, medVtkLookUpTable enters a mode for representing categorical color maps.
...
#ifndef __medVtkLookUpTable_h
#define __medVtkLookUpTable_h
...
class medVtkLookUpTable : public vtkLookupTable
{
public:
  // Description:
  ...
  // (from red to blue).
  static medVtkLookUpTable *New();

  vtkTypeMacro(medVtkLookUpTable,vtkLookupTable);
...
protected:
  medVtkLookUpTable(int sze=256, int ext=256);
  ~medVtkLookUpTable();
...
private:
  medVtkLookUpTable(const medVtkLookUpTable&);  // Not implemented.
  void operator=(const medVtkLookUpTable&);  // Not implemented.
};

//----------------------------------------------------------------------------
inline unsigned char *medVtkLookUpTable::WritePointer(const vtkIdType id,
                                                   const int number)
{
